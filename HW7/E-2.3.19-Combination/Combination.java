public class Combination
{
    ...
    public static void main(String[] args)
    {
        ...
        // Hint 1 : choice of the each letter in a particular 
        //combination can be a true/false on the choice array
        // Example: if choice[4] = [true, false, true, false], 
        //then the output should be "ac"

        // Hint 2 : The 'start' position is to increment towards
        // choice.length, and at each step, it chooses to include
        // letter[i] or not letter[i] by setting choice[i] to 
        //true or false.
