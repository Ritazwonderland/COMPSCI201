public class Tree {
    public static void tree(int n, double x, double y, double a, double branchRadius) {
        //int n	recursive step
        //double x,y: coordinate of the root of the tree
        //double a: Initial angle, in radian. 
            //π/2 is a vertical upward direction
        //double branchRadius: length of branch

        double bendAngle   = Math.toRadians(15);
        double branchAngle = Math.toRadians(37);
        double branchRatio = 0.65; 

        // coordinates of the tip of the trunk 
        //base on the angle and radius
        double cx = x + Math.cos(a) * branchRadius; 
        double cy = y + Math.sin(a) * branchRadius;
        
        StdDraw.setPenRadius(0.001 * Math.pow(n+1, 1.2)); 
        ...
        // Next, we recursively draw 3 branches 
        // 0. The starting point is (cx, cy)
        // -- The order of recursive call need to follow this 
        //order to pass SAG
        ...
        // 4. middle branch 's radius is 
        //branchRadius * (1 - branchRatio));
        // 5. both left and right  branch's radius is 
    ...
    public static void main(String[] args) {
        ...
        // The tree stands in the middle at the bottom the 
        //canvas, growing vertically upward.
