public class HeartCurve {
    public static void main(String[] args) {
        ...
        {    
            ...
            x1 = 2*a*(1-Math.cos(Math.toRadians(t)))*Math.sin(Math.toRadians(t));
            y1 = 2*a*(1-Math.cos(Math.toRadians(t)))*Math.cos(Math.toRadians(t));
        ...
        // Remember to have `export DISPLAY=:1` in 
        //the ~/.bashrc or ~/.zshrc,
