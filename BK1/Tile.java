...
public class Tile {//1 by 1 square
    ...
    public ArrayList<String> getMoves(int i,ArrayList<String> moves,Map mainMap){
    ...
    public void checkAndMove(String direction, Map mainMap){
        switch (direction){
            case "up":
            case "down":
...
class Tile2by1 extends Tile{//vertical line
    ...
    @Override
    public boolean horizontalCheck(String direction, Map mainMap) {
        //System.out.println("2b1,good");
        //System.out.println(getTile(0).horizontalCheck(direction,mainMap));
        //System.out.println(getTile(1).horizontalCheck(direction,mainMap));
